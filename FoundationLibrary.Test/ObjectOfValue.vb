...
<TestClass()> Public Class ObjectOfValues
    ...
    <TestMethod()> Public Sub ObjectOfInteger()
        Dim int As New FoundationLibrary.ObjectOfValue.ObjectOfInteger(1)
    ...
    <TestMethod> Public Sub ObjectOfString()
        Dim str As New FoundationLibrary.ObjectOfValue.ObectOfString("Malakia")
        Console.WriteLine(str.Value)
        Assert.AreEqual(str.Value, "Malakia")
    End Sub

    <TestMethod()> Public Sub ObjectOfDate()
        Dim dat As New FoundationLibrary.ObjectOfValue.OBjectOfDate("23/06/1995")
    ...
    <TestMethod> Public Sub ObjectOfBoolean()
        Dim Bool As New FoundationLibrary.ObjectOfValue.ObjectOfBoolean(0)
        Console.WriteLine(Bool.Value)
        Assert.IsFalse(Bool.Value)
    End Sub

    <TestMethod> Public Sub ObjectOfDouble()
        Dim Doub As New FoundationLibrary.ObjectOfValue.ObjectOfDouble(0.25)
